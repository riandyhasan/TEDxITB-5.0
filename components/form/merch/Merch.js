...
export default function MerchForm({ data, user }) {
  ...
  const addToFirestore = async () => {
    try {
      ...
      let price = [];
      cart?.map((i) => {
        product.push(`${i.quantity} x ${i.name}`);
        price.push(formatter.format(String(i.price * i.quantity)));
      });
      // const products = EMAIL_TEMPLATE(product, price, prodQty);
      const emailBody = {
        date: date,
        name: name,
        items: product,
      ...
      emailjs
        .send("tedxitb5.0", "tedxitb5", emailBody, "user_hoFpG3XhPIIfpZRHHO38o")
        .then(
          (result) => {
  ...
  return (
    <Flex
      w="100%"
      padding="2rem"
      bg="linear-gradient(180deg, #FFFFFF 23.76%, #E62B1E 44.24%)"
    >
      <Flex
        bg="white"
        ...
        >
          <Grid gridTemplateColumns="repeat(1, 1fr)" gap={4} w="100%">
            ...
            <GridItem>
              <FormControl isRequired>
                ...
                <Input
                  ...
                  border="2px"
                  borderColor="black"
                  isDisabled={shipping == "shipping" ? false : true}
                  value={address}
            ...
            <GridItem>
              <FormControl isRequired>
                ...
                <Box fontSize="0.65em" mt="-0.5rem" mb="0.7rem">
                  If you choose pick up, the product available at Venue Event
                  TEDxITB: soon to be announced
                </Box>
                <Select
                  fontSize="0.65em"
                  borderRadius="19px"
              ...
              <FormControl>
                ...
                <Box fontSize="0.65em" mb="0.7rem" mt="-0.5rem">
                  <Text fontWeight="bold">
                    Do you have any referral code? Please fill in with your
                    referral code to get discount!
                  </Text>
                  ...
                  <UnorderedList fontStyle="italic">
                    <ListItem>
                      Referral code can be obtained from TEDxITB 5.0 committee.
                    </ListItem>
                    <ListItem>
                      Referral code can not be used during promo session.
                    </ListItem>
                  </UnorderedList>
                </Box>
                <Input
            ...
            <GridItem>
              <FormControl>
                ...
                <Box fontSize="0.65em" mb="0.7rem" mt="-0.5rem">
                  BCA 1481793578 a.n Raisa Rasyida Putri Setiawan
                </Box>
              </FormControl>
              <Box
          ...
          >
            <Box border="2px solid #F0592B" borderRadius="21px" w="100%">
              <Box
                bg="linear-gradient(180deg, #F0592B 0%, rgba(235, 83, 73, 0.91) 100%)"
                px="2rem"
                py="0.5rem"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <Text>
                          {formatter.format(String(item.price * item.quantity))}
                        </Text>
                      </Flex>
            ...
            <Flex flexDir="column" justifyContent="center" gridGap="2rem">
              ...
              >
                ...
                {cart?.map((i) => {
                  ...
                  return (
                    <Flex justifyContent="space-between">
                      <Text>{i.name}</Text>
                      <Text>
                        {formatter.format(String(i.price * i.quantity))}
                      </Text>
                    </Flex>
                  );
                })}
                ...
                <Flex justifyContent="space-between">
                  ...
                  <Text color="red">
                    -{formatter.format(String(referralcodeDiscount))}
                  </Text>
                </Flex>
